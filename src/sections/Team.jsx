            ...
            <div className='flex justify-center items-center text-center w-full text-white bg-black border border-[#D4C5A0]'>
                <div className='flex flex-col gap-8 justify-center items-center px-3 mt-20 max-sm:mt-10 min-w-sm max-w-3xl'>
                    ...
                    <div className='flex justify-center gap-2'>
                        <button className='font-Roboto border border-[#D4C5A0] py-2 px-5 hover:bg-slate-500 cursor-pointer'>Meet our team</button>
                        <button className='font-Roboto py-2 px-5 hover:bg-slate-500 cursor-pointer'>Learn more <i class="fa-solid fa-angle-right"></i></button>
                    </div>
