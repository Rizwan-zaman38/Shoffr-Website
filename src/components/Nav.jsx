            ...
            <nav className='flex justify-between items-center py-4 px-16 '>
                ...
                <div className='hidden md:flex justify-between items-center'>
                    <ul className='flex justify-between items-center font-Roboto mr-2'>
                        ...
                        <li className='hover:bg-slate-100 py-2 px-4 rounded-1xl'><a href="">More <i class="fa-solid fa-chevron-down"></i></a></li>
                    </ul>
                    <div className='flex gap-2'>
                        <button className='font-Roboto border border-[#C5A13E] py-2 px-5 hover:bg-slate-200 cursor-pointer'>Book</button>
                        <button className='font-Roboto border bg-black text-white py-2 px-5 hover:bg-slate-200 cursor-pointer'>Contact</button>
                    </div>
                </div>
